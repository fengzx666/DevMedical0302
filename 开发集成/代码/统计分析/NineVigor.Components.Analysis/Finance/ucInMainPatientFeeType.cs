...
{
    public partial class ucInMainPatientFeeType : NineVigor.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucInMainPatientFeeType()
        {
            InitializeComponent();
        }
