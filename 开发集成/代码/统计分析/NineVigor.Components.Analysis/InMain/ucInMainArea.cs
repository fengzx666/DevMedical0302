...
{
    public partial class ucInMainArea : NineVigor.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucInMainArea()
        {
            InitializeComponent();
        ...
        private void ucInMainArea_Load(object sender, EventArgs e)
        {
        ...
        private DataTable CreateData()
        {
            ...
            dt = finBiz.GetAreaProvinceOutInData("ALL", this.dtBeginDate.Value.ToString("yyyy-MM-dd"), this.dtEnd.Value.ToString("yyyy-MM-dd"));
        ...
        private void CreateChart(DataTable dt)
        {
            ...
            chartTitle.Text = "省内外就诊人数分析（单位：人次） 分析记录数:" + dt.Rows[0][0].ToString();
