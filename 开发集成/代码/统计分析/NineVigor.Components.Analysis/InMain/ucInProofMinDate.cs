...
{
    public partial class ucInProofMinDate : NineVigor.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucInProofMinDate()
        {
            InitializeComponent();
        }
        ...
        private DataTable CreateData()
        {
            ...
            dt = finBiz.GetProofMinusData("ALL", this.dtBeginDate.Value.ToString("yyyy-MM-dd"), this.dtEnd.Value.ToString("yyyy-MM-dd"));
        ...
        private void CreateChart(DataTable dt)
        {
            ...
            chartTitle.Text = "住院证登记接诊时间分析（单位：分钟） 分析记录数:" + dt.Rows[0][0].ToString();
