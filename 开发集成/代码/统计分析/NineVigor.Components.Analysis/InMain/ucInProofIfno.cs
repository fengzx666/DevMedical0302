...
{
    public partial class ucInProofIfno : NineVigor.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucInProofIfno()
        {
            InitializeComponent();
        }
        private Series seriesCommon = null;
        private void ucInProofIfno_Load(object sender, EventArgs e)
        {
        ...
        private DataTable CreateData()
        {
            ...
            dt = finBiz.GetProofData("ALL",this.dtBeginDate.Value.ToString("yyyy-MM-dd"),this.dtEnd.Value.ToString("yyyy-MM-dd"));
        ...
        private void CreateChart(DataTable dt)
        {
         ...
         chartTitle.Text = this.comboBox1.Text;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count >= 3)
            {
                ...
                Series series1 = CreateOldSeries(drItem[0].ToString(), ViewType.Pie, dt, selectIndex);
                iCount = iCount + 1;
                list.Add(series1);
            }
