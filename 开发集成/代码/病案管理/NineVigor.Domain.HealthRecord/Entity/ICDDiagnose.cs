...
{
    public class ICDDiagnose : BaseEntity, IICDDiagnose
  {
      #region  变量
      /// <summary>
      /// 主键
      ...
      #region 实例反射化实体内容
      private NineVigor.Domain.HealthRecord.Repository.IICDMaintenceRepository icdMaintenceRepository = null;
      /// <summary>
      /// 用户实体的职责实体内容
      /// </summary>
      protected virtual NineVigor.Domain.HealthRecord.Repository.IICDMaintenceRepository ICDMaintenceRepository
      {
          get
          {
              if (this.icdMaintenceRepository == null)
              {
                  icdMaintenceRepository = RepositoryFactory.CreateRepository<IICDMaintenceRepository>();
              }
              return icdMaintenceRepository;
          }
      }
      ...
      {
          return this.ICDMaintenceRepository.SelectDiagnoseAll();
      }
